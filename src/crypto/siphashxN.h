...
static void siphash24x4(const siphash_keys *keys, const uint64_t *indices, uint64_t *hashes) {
...
static void siphash24x8(const siphash_keys *keys, const uint64_t *indices, uint64_t *hashes) {
...
static void siphash24x16(const siphash_keys *keys, const uint64_t *indices, uint64_t *hashes) {
  const __m256i packet0 = _mm256_load_si256((__m256i *)indices);
  const __m256i packet4 = _mm256_load_si256((__m256i *)(indices+4));
...
static void siphash24x2(const siphash_keys *keys, const uint64_t *indices, uint64_t *hashes) {
...
static void siphash24xN(const siphash_keys *keys, const uint64_t *indices, uint64_t * hashes) {
#if NSIPHASH == 1

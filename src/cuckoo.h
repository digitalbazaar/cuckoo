...
static node_t sipnode(siphash_keys *keys, edge_t edge, u32 uorv) {
...
static int verify(edge_t edges[PROOFSIZE], siphash_keys *keys) {
...
static edge_t sipnode_(siphash_keys *keys, edge_t edge, u32 uorv) {
